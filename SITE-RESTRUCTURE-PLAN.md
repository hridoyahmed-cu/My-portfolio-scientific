...
17. **Gallery captions.** Tag laboratory photographs in `src/data/gallery.ts` and
    replace the generated alt text with real captions. Tagged items sort to the front.
